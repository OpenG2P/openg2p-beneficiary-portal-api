...
from .controllers.document_file_controller import BeneficiaryDocumentFileController
from .controllers.form_controller import BeneficiaryFormController
...
class Initializer(Initializer):
    def initialize(self, **kwargs):
        ...
        MembershipService()
        ProgramService()
        BeneficiaryDocumentFileService()
        BeneficiaryFormService()

        DiscoveryController().post_init()
        ProgramController().post_init()
        BeneficiaryDocumentFileController().post_init()
        BeneficiaryFormController().post_init()
